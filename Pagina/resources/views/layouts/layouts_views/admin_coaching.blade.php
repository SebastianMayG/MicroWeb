        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="/usuario"><i class="fa fa-circle-o"></i> Tips</a></li>
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Asesorias	</h3>
                        ...
                        <div class="col-md-12">
                          <div id="asesores">
                              <div class="card">
                                ...
                                <p>Asesor en casarse con hijas del patrón</p>
                                <button class="compra_asesoria" disabled>Asesorías</button>
                              </div>
                              <div class="card">
