...
<div id="tips-slider">
  <div id="tips">
    <div class="tips_alone">
      <header class="encabezado"><h1> Define claramente tu visión y objetivos: </h1></header>
    ...
    <div class="tips_alone">
      <header class="encabezado"><h1> Conoce a tu público objetivo: </h1></header>
    ...
    <div class="tips_alone">
      <header class="encabezado"><h1> Ofrece un producto o servicio único: </h1></header>
    ...
    <div class="tips_alone">
      <header class="encabezado"><h1> Mantén un control financiero riguroso: </h1></header>
    ...
    <div class="tips_alone">
      <header class="encabezado"><h1> Invierte en marketing y promoción: </h1></header>
